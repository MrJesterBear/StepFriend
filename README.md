...
- Waypoints and Coordinates for the map screen are weirdly incorrect. WIth the waypoints being the correct data, but the starting/ending coords are sort of correct sort of not.
> Not sure why this is happening, as the logic from the looks of it is completely fine.

# Last Update: 10th December 2025 - 00:18